...
use Magezon\Blog\Controller\Post\View as ViewPostAction;

class FixPostViewControllerEntitySpecificHandles
{
    /**
     * @var HttpRequest
     */
    ...
    /**
     * Exclude the blog_post_view layout handle from being loaded on ESI requests.
     *
     * If the FPC is turned on and varnish is used, the top menu rendering throws an exception because
     * blog_post_view expects a current_category to be set in the registry.
     *
     * @param ViewPostAction $subject
     */
    public function beforeExecute(ViewPostAction $subject)
    {
